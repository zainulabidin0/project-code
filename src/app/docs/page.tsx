    ...
    <DocsChrome subnav="hub" showCopyPrompt={false}>
      <main className="relative z-10 mx-auto max-w-3xl px-6 pb-32 pt-12">
        ...
        <p className="mt-3 text-base text-zinc-500">
          ...
          with stored reviews, and a Shopify shopping assistant (ShopAssist).
          Address and reviews use one API key per project; ShopAssist uses an
          installed Shopify store domain instead. Base:{" "}
